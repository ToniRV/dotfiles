...
Module {
    ...
    property stringList config: ["file_copies", "qt", "warn_on", "release", "link_prl", "incremental", "shared", "qpa", "release", "qt_no_framework", "linux", "unix", "posix", "gcc"]
    property stringList qtConfig: ["minimal-config", "small-config", "medium-config", "large-config", "full-config", "fontconfig", "libudev", "evdev", "xkbcommon-evdev", "xlib", "xrender", "xcb-plugin", "xcb-render", "xcb-glx", "xcb-xlib", "xcb-sm", "accessibility-atspi-bridge", "linuxfb", "kms", "c++11", "c++14", "c++1z", "accessibility", "opengl", "shared", "qpa", "reduce_exports", "reduce_relocations", "clock-gettime", "clock-monotonic", "posix_fallocate", "mremap", "getaddrinfo", "ipv6ifname", "getifaddrs", "inotify", "eventfd", "threadsafe-cloexec", "poll_poll", "system-png", "png", "doubleconversion", "system-freetype", "system-harfbuzz", "system-zlib", "mtdev", "cups", "iconv", "glib", "dbus", "dbus-linked", "openssl", "libproxy", "xcb", "xinput2", "rpath", "alsa", "pulseaudio", "gstreamer-1.0", "icu", "concurrent", "audio-backend", "release"]
    property path binPath: "/opt/qt57/bin"
    property path incPath: "/opt/qt57/include"
    property path libPath: "/opt/qt57/lib"
    property path pluginPath: "/opt/qt57/plugins"
    property string mkspecName: "linux-g++"
    property path mkspecPath: "/opt/qt57/mkspecs/linux-g++"
    ...
    property path docPath: "/opt/qt57/doc"
    ...
    property string libFilePathRelease: "/opt/qt57/lib/libQt5Core.so.5.7.1"
    ...
    cpp.includePaths: {
        var paths = ["/opt/qt57/include", "/opt/qt57/include/QtCore"];
